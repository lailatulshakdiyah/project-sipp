...
export default function MapHots({ hotspots = [] }) {
  ...
  useEffect(() => {
    ...
    const createColoredIcon = (color) => {
      ...
      `;
      return new L.Icon({
        iconUrl: `data:image/svg+xml;base64,${safeBtoa(svgIcon)}`,
        iconSize: [25, 25],
        iconAnchor: [16, 32],
        popupAnchor: [0, -32],
      });
    ...
    setIcons({
      low: createColoredIcon("#52AF53"),
      medium: createColoredIcon("#F9C132"),
      high: createColoredIcon("#FF0000"),
    });
  }, []);
